...
//     {
//         delta_ =
//             abi.decode(manager.unlock(abi.encode(CallbackData(msg.sender, _key, _params, _referrer))),
// (BalanceDelta));
//     }
...
//         int256 deltaBefore0 = manager.currencyDelta(address(this), data.key.currency0);
//         int256 deltaBefore1 = manager.currencyDelta(address(this), data.key.currency1);
